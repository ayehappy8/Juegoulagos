...
class personaje(object):
	...
	def __init__(self, x, y, fuente):
		...
		self.camina_abajo = [pygame.image.load("img/"+fuente+"/f1.png"), pygame.image.load("img/"+fuente+"/f2.png"), pygame.image.load("img/"+fuente+"/f3.png"), pygame.image.load("img/"+fuente+"/f4.png")]
		self.camina_arriba = [pygame.image.load("img/"+fuente+"/b1.png"), pygame.image.load("img/"+fuente+"/b2.png"), pygame.image.load("img/"+fuente+"/b3.png"), pygame.image.load("img/"+fuente+"/b4.png")]
	...
	def dibujar(self, cuadro):
		...
		if self.va_izquierda:
			...
			cuadro.blit(self.camina_arriba[self.contador_pasos//7],(self.x,self.y))
			self.contador_pasos += 1

		elif self.va_arriba:
			cuadro.blit(self.camina_abajo[self.contador_pasos//7],(self.x,self.y))
			self.contador_pasos += 1
