...
while repetir:
	...
	villanos = [personaje(100, int(ventana_y - 300),"villano",800),personaje(10, int(ventana_y - 150),"villano2",800), personaje(30, int(ventana_y - 500),"villano3",500),  personaje(80, int(ventana_y - 400),"villano4",600)]
	villano= villanos[nivel]
