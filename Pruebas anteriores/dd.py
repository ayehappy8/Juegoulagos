...
while repetir:
	...
	villanos = [personaje(100, int(ventana_y - 300),"villano",800),personaje(10, int(ventana_y - 150),"villano",800), personaje(40, int(ventana_y - 250),"villano",800),  personaje(60, int(ventana_y - 300),"villano",800)]
	villano= villanos[nivel]
