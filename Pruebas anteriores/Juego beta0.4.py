...
while repetir:
	...
	villanos = [personaje(100, int(ventana_y - 300),"villano",800),personaje(10, int(ventana_y - 150),"villano",800), personaje(30, int(ventana_y - 500),"villano2",500),  personaje(80, int(ventana_y - 400),"villano",600)]
	villano= villanos[nivel]
	...
	while esta_en_intro:
		...
		ventana.blit(pygame.image.load('img/Menu/main_menu.jpg'),[0,0]) # pinta el fondo de negro
