...
while repetir:
	...
	imagen_fondo = [pygame.image.load(
        'img/Ecenario/habitacion1.png'), pygame.image.load('img/Ecenario/habitacion2.png'), pygame.image.load('img/Ecenario/habitacion3.png'),pygame.image.load('img/Ecenario/habitacion3.png')]
	...
	texto_nivel = pygame.font.SysFont('Foorlight MT Light', 50, True)   
	texto_intro = pygame.font.SysFont('console', 30, True)
	texto_resultado = pygame.font.SysFont('console', 80, True)
	esta_en_intro = True
	gana = False
	fondo_intro = [pygame.image.load('img/Menu/main_menu.png')]
	...
	while esta_en_intro:
		...
		intrucciones = texto_intro.render('Presione ENTER para comenzar...', 1, (255,255,255))
		ventana.blit(intrucciones, ((ventana_x//2)-intrucciones.get_width()//2, 300))
